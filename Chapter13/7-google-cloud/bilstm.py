...
def read_data(file_name):
    ...
    with file_io.FileIO(file_name, mode='r') as fin:
        for line in fin:
...
if __name__ == '__main__':
    ...
    # save the model
    with file_io.FileIO('bi_lstm_sentiment.h5', mode='r') as input_f:
        with file_io.FileIO(args.job_dir + '/bi_lstm_sentiment.h5', mode='w+') as output_f:
